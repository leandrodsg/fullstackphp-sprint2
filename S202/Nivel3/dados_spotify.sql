...
-- cartao vinculado assinatura de ana
...
-- artistas similares auto-relacionamento
...
(1, 1, now()), -- ana segue banda alpha
(2, 2, now()); -- joao segue dj beta

-- favoritos
insert into favorito_musica (usuario_id, musica_id, data_favorito) values
(1, 1, now()), -- ana favoritou intro alpha
(2, 2, now()); -- joao favoritou batida beta

insert into favorito_album (usuario_id, album_id, data_favorito) values
(1, 1, now()); -- ana favoritou primeiro som
...
-- musicas nas playlists inclui quem adicionou
insert into playlist_musica (playlist_id, musica_id, adicionado_por, data_adicao) values
(1, 1, 1, now()), -- ana adicionou intro alpha na propria playlist
(1, 3, 1, now()), -- ana adicionou alpha remix
(2, 2, 2, now()); -- joao adicionou batida beta
